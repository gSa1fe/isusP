...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: 'google') => {
    ...
    try {
      ...
      toast.error(`เข้าสู่ระบบด้วย ${provider} ไม่สำเร็จ`)
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md border-border bg-card">
        ...
        <CardContent className="space-y-4">
          ...
          <div className=" grid-cols-2 gap-3 justify-center">
            <Button 
              variant="outline" 
              className="w-full  bg-white hover:bg-gray-50 text-white border-gray-300"
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">หรือเข้าสู่ระบบด้วยอีเมล</span>
            </div>
          </div>
